...
my_ball=ballphy.Ball(ball_x,ball_y)
...
while running:
    ...
    if state == "game":
      ...
      if keys[pygame.K_UP] and player_selected.rect.bottom >= floor.top:
            player_selected.player_speed_y = -18
      ...
      if keys[pygame.K_w] and rival_selected.rect.bottom >= floor.top:
        rival_selected.player_speed_y = -18
    ...
    for selected_player in (player_selected, rival_selected):
        ...
        if selected_player.player_speed_y > 0:
            selected_player.player_speed_y = 0


        selected_player.player_speed_y += selected_player.gravity * dt

        selected_player.rect.y += selected_player.player_speed_y * dt
...
# BALL PHYSICS
  ...
  ##MAIN SCREEN
    ...
    if state == "game":
      ...
      pygame.draw.circle(screen, (255, 255, 250), (int(my_ball.ball_x), int(my_ball.ball_y)), my_ball.getRadius())
    pygame.display.flip()
print("Game Over")
pygame.quit()
sys.exit()
